 ...
 *
 */
public class Theory6driveSraightCommand extends Command {
    ...
    public Theory6driveSraightCommand(double targetDistance, double speed, double targetAngle, double epsilon) {
