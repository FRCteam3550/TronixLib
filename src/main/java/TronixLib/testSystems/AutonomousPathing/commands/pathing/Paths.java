...
//		public static final Point START_POINT = new Point(9, 127);
//		public static final Point CONTROL_POINT_ONE = new Point(10, 90);
//		public static final Point CONTROL_POINT_TWO = new Point(94, 120);
//		public static final Point END_POINT = new Point(90, 55);
//		
		...
		public static final Path SCALE_RIGHT_TRAVEL = straightLength(24);//Original value = 224
		public static final Path SCALE_RIGHT_FINISH = new Path(
				new PathSegment(t -> 
				/* {"start":{"x":3,"y":140},"mid1":{"x":85,"y":146},"mid2":{"x":5,"y":85},"end":{"x":81,"y":85}} */
				(18 + -402 * t + 384 * Math.pow(t, 2))/
		(246 + -972 * t + 954 * Math.pow(t, 2)) 
				, (114.283))
				);
