...
public class AutoDriveDistanceCommand extends Command {
	...
	// feedfordward   constant
	private static final double kF = 0;
	
	public static final double MAX_OUTPOUT_SPEED = 0.8; // 0.6 test yesterday// 0.55 competition
	...
	public AutoDriveDistanceCommand(double distance, int direction) {
		if(direction == 0){
