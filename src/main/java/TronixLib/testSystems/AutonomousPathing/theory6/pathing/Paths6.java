...
//	}
	...
	public static class FROM_RIGHT {
		public static final Point START_POINT = new Point(6, 97);
		public static final Point CONTROL_POINT_ONE = new Point(26, 168);
		public static final Point CONTROL_POINT_TWO = new Point(102, 95);
		public static final Point END_POINT = new Point(114, 182);
		}
}
...
//				, 50)
//				);
//		public static final Path SCALE_RIGHT_TRAVEL = straightLength(10);//Original value = 224
//		public static final Path SCALE_RIGHT_FINISH = new Path(
//				new PathSegment(t -> 
//				/* {"start":{"x":6,"y":97},"mid1":{"x":26,"y":26},"mid2":{"x":102,"y":99},"end":{"x":114,"y":12}} */
//				(-213 + 864 * t + -912 * Math.pow(t, 2))/ (60 + 336 * t + -360 * Math.pow(t, 2)) 
//				, 154)
//				);
//
