...
public class PIDController {
	...
	public double calcPID(double setPoint, double currentValue, double epsilon) {
		//System.out("errorCalcPid"+error);
		error = setPoint - currentValue;
		System.out.println("setPointCalcPID = "+ setPoint);
		System.out.println("currentValueCalcPID = "+ currentValue);
		System.out.println("errorCalcPID = "+ error);
		...
		// P
		pOut = pGain * error;
		System.out.println("pOutCalcPID = "+ pOut);
		// I
		errorSum += error;
		iOut = iGain * errorSum;
