 ...
 * the project.
 */
public class RobotMontreal extends IterativeRobot {
	...
	SendableChooser<Command> m_autoChooserLeft;
	SendableChooser<Command> m_autoChooserRight;
...
//	public int CoteBalanceAuto;
    ...
    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=CONSTRUCTORS
        ...
        m_autoChooserLeft = new SendableChooser<Command>();
        ...
        m_autoChooserLeft.addDefault("Pos1LeftBascule", new Pos1ColorLeftObjCubeBasculeCommand());
        ...
        m_autoChooserLeft.addObject("Pos1ColorLeftObjCubeBalance",        new Pos1ColorLeftObjCubeBalanceCommand());
        //m_autoChooserLeft.addObject("Pos1ColorRightObjCubeBascule",       new Pos1ColorRightObjCubeBasculeCommand());
        m_autoChooserLeft.addObject("Pos2ColorLeftObjCubeBascule1",       new Pos2ColorLeftObjCubeBascule1Command());
        ...
        //m_autoChooserLeft.addObject("Pos2ColorRightObjCubeBascule2",      new Pos2ColorRightObjCubeBascule2Command());
        m_autoChooserLeft.addObject("Pos3ColorLeftObjCubeBascule",        new Pos3ColorLeftObjCubeBasculeCommand());
        //m_autoChooserLeft.addObject("Pos3ColorRightObjCubeBascule",       new Pos3ColorRightObjCubeBasculeCommand());
        m_autoChooserLeft.addObject("Pos4ColorLeftObjCubeBalance",        new Pos4ColorLeftObjCubeBalanceCommand());
        m_autoChooserLeft.addObject("Pos4ColorLeftObjCubeBascule",        new Pos4ColorLeftObjCubeBasculeCommand());
        ...
        m_autoChooserRight = new SendableChooser<Command>();
        
        // Dans AutonomousInit on assume qu'on est en position 4 pour demarrer ce choix plutot
        // que de se contenter d'un simple autoline. Donc meilleur choix par defaut est celui-ci...
        m_autoChooserRight.addDefault("Pos4RightBascule", new Pos4ColorRightObjCubeBasculeCommand());
        ...
        //m_autoChooserRight.addObject("Pos1ColorLeftObjCubeBalance",        new Pos1ColorLeftObjCubeBalanceCommand());
        m_autoChooserRight.addObject("Pos1ColorRightObjCubeBascule",       new Pos1ColorRightObjCubeBasculeCommand());
        ...
        m_autoChooserRight.addObject("Pos2ColorRightObjCubeBascule1",      new Pos2ColorRightObjCubeBascule1Command());
        //m_autoChooserRight.addObject("Pos2ColorRightObjCubeBascule2",      new Pos2ColorRightObjCubeBascule2Command());
        //m_autoChooserRight.addObject("Pos3ColorLeftObjCubeBascule",        new Pos3ColorLeftObjCubeBasculeCommand());
        m_autoChooserRight.addObject("Pos3ColorRightObjCubeBascule",       new Pos3ColorRightObjCubeBasculeCommand());
        ...
        m_autoChooserRight.addObject("Pos4ColorRightObjCubeBalance",       new Pos4ColorRightObjCubeBalanceCommand());
        m_autoChooserRight.addObject("Pos4ColorRightObjCubeBascule",       new Pos4ColorRightObjCubeBasculeCommand());
        
        SmartDashboard.putData("AutoModeRight", m_autoChooserRight);

		//installAutonomous();
		
        SmartDashboard.putBoolean("DetectCube", RobotMontreal.pinceSubsystem.IsCubeHere());
    }
...
//		
    ...
    public void autonomousInit() {
    	...
    	if (tempGameData.charAt(0) == 'L') // Bascule cote gauche
       // if (false)
		{
			m_autonomousCommand = (Command) m_autoChooserLeft.getSelected();
       ...
       // else if (true)
		...
		{
    		m_autonomousCommand = (Command) m_autoChooserRight.getSelected();
	    	if (m_autonomousCommand != null) {
	    		m_autonomousCommand.start();
	    	}
		}
	...
	private void log() {
		...
		SmartDashboard.putBoolean("PetitCadreUp", RobotMontreal.PetitCadreSubsystem.PetitCadreIsUp());
		SmartDashboard.putBoolean("PetitCadreDown", RobotMontreal.PetitCadreSubsystem.PetitCadreIsDown());
		SmartDashboard.putBoolean("GrandCadreUp", RobotMontreal.GrandCadreSubsystem.GrandCadreIsUp());
		SmartDashboard.putBoolean("GrandCadreDown", RobotMontreal.GrandCadreSubsystem.GrandCadreIsDown());
